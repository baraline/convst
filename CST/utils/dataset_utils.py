...
def return_all_dataset_names():
    return ['ACSF1', 'Adiac', 'ArrowHead', 'Beef', 'BeetleFly', 'BirdChicken',
       ...
       'SonyAIBORobotSurface1', 'SonyAIBORobotSurface2', 'Strawberry',
       'SwedishLeaf', 'Symbols', 'SyntheticControl', 'ToeSegmentation1',
       'ToeSegmentation2', 'Trace', 'TwoLeadECG', 'TwoPatterns', 'UMD',
