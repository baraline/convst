...
# In[]:
df_latex = df[['Dataset','CST_mean','CST_std','MiniRKT_mean','MiniRKT_std','SFC_mean','SFC_std']].astype(str)
df_latex['CST'] = df_latex['CST_mean'].str[0:5] + ' (+/- '+  df_latex['CST_std'].str[0:5]+')'
